...
export class Backend implements backendInterface {
    ...
    async addPoemToCollection(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPoemToCollection(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createCollection(arg0: string, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getAllCollections(): Promise<Array<CollectionView>> {
        if (this.processError) {
            try {
    ...
    async getAllPoems(): Promise<Array<Poem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPoems();
    ...
    async getPoemById(arg0: bigint): Promise<Poem> {
        if (this.processError) {
            try {
                const result = await this.actor.getPoemById(arg0);
                return from_candid_Poem_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getPoemsByCollectionId(arg0: bigint): Promise<Array<Poem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPoemsByCollectionId(arg0);
                return from_candid_vec_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removePoemFromCollection(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removePoemFromCollection(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchPoems(arg0: string): Promise<Array<PoemSearchResult>> {
        if (this.processError) {
            try {
    ...
    async submitPoem(arg0: string, arg1: string, arg2: string, arg3: PoemType, arg4: ExternalBlob | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitPoem(arg0, arg1, arg2, to_candid_PoemType_n23(this._uploadFile, this._downloadFile, arg3), await to_candid_opt_n25(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_PoemSearchResult_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PoemSearchResult): Promise<PoemSearchResult> {
    return await from_candid_record_n22(_uploadFile, _downloadFile, value);
}
function from_candid_PoemType_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PoemType): PoemType {
    return from_candid_variant_n14(_uploadFile, _downloadFile, value);
}
async function from_candid_Poem_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Poem): Promise<Poem> {
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        poemType: from_candid_PoemType_n13(_uploadFile, _downloadFile, value.poemType),
        author: value.author,
...
async function from_candid_record_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        poem: await from_candid_Poem_n11(_uploadFile, _downloadFile, value.poem),
...
function from_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "text" in value ? PoemType.text : "image" in value ? PoemType.image : value;
}
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Poem>): Promise<Array<Poem>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Poem_n11(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PoemSearchResult>): Promise<Array<PoemSearchResult>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PoemSearchResult_n21(_uploadFile, _downloadFile, x)));
}
...
function to_candid_variant_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PoemType): {
    ...
    return value == PoemType.text ? {
        text: null
    } : value == PoemType.image ? {
        image: null
    } : value;
}
