...
export interface _SERVICE {
  ...
  'getIsDraftModeEnabled' : ActorMethod<[], boolean>,
  ...
  'getVersion' : ActorMethod<[], [bigint, bigint, bigint]>,
  'isCallerAdmin' : ActorMethod<[], boolean>,
  'markNotificationAsRead' : ActorMethod<[bigint], undefined>,
  'publishToProduction' : ActorMethod<[], undefined>,
  ...
  'setDraftMode' : ActorMethod<[boolean], undefined>,
